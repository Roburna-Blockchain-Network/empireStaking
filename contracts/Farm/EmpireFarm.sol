...
contract EmpireFarming is Ownable {
    ...
    IEmpireFarmTresuary public tresuary;
    ...
    event TresuaryUpdated(IEmpireFarmTresuary oldTresuary, IEmpireFarmTresuary newTresuary);
    ...
    function setTresuary(IEmpireFarmTresuary _tresuary) external onlyOwner {
